...
import { sideNavItems, sideNavSections, sideNavItemsRorB2, sideNavSectionsForB2 } from '@modules/navigation/data';
...
export class LayoutDashboardComponent implements OnInit, OnDestroy {
    ...
    sideNavItemsForB2 = sideNavItemsRorB2;
    sideNavSectionsForB2 = sideNavSectionsForB2;
